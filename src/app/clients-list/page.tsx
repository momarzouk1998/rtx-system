          ...
          <table className="w-full text-right" dir="rtl" style={{ width: 'max-content', minWidth: '100%' }}>
            <thead className="table-header border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-4">إجمالي المسحوبات</th>
                <th className="px-6 py-4">إجمالي المدفوعات</th>
                  ...
                  return (
                    <tr key={client.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm font-medium">
                        <Link href={`/statement?client=${client.id}`} className="text-[#12829b] hover:text-[#0ea5e9] hover:underline">
                          كشف حساب
                        </Link>
                      </td>
                    </tr>
