...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen fixed top-0 right-0 bg-[#2b2b2b] text-white border-l border-white/5 flex flex-col z-50">
      {/* Header matching AppSheet cyan background */}
